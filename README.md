...
## About this project
Welcome to my Tableau dashboards which visualize NYC flight delay patterns in 2013 by different dimensions. These dashboards are designed as a practical tool to help users better predict flight departure and arrival delays: users are able to easily interact with the dashboards and  visualize the average delay time by selecting various parameters, such as their arrival and departure locations, flight times, airlines, and airplane manufacturers.
